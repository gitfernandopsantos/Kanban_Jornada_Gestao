...
import { KanbanCard, KanbanList } from '../models/kanban';
...
export class KanbanService {
    ...
    addList() {
        ...
        const title = "Clique aqui, para mudar o nome da coluna";
        const newList = {
            listId: listId,
            title: title,
            cards: []
    ...
    addCard(listId: string) {
        ...
        const title = "Clique aqui, para mudar o nome da atividade";
